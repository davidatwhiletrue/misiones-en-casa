  ...
  return (
    <div className="max-w-lg mx-auto px-4 py-6">
      <div className="flex items-center justify-between mb-6">
        <h1 className="text-2xl font-bold text-white">✨ Crear Misión</h1>
        <Link
          href="/admin"
      ...
      <form action={createMission} className="space-y-5 glass-card p-5">
        <div>
          <label htmlFor="title" className={labelClass}>Título</label>
          <input type="text" id="title" name="title" required placeholder="Ej: Fregar los platos" className={inputClass} />
        </div>
        ...
        <div className="grid grid-cols-2 gap-3">
          <div>
            ...
            <input type="number" step="0.1" min="0" id="reward" name="reward" defaultValue="0" required className={inputClass} />
          </div>
          <div>
            <label htmlFor="xpReward" className={labelClass}>⚡ XP</label>
            <input type="number" min="0" id="xpReward" name="xpReward" defaultValue="10" required className={inputClass} />
          </div>
        </div>
        ...
        <div className="grid grid-cols-2 gap-3">
          ...
          <div>
            ...
            <select id="difficulty" name="difficulty" className={inputClass}>
        ...
        <div className="grid grid-cols-2 gap-3">
          <div>
            ...
            <select id="rarity" name="rarity" className={inputClass}>
          ...
          <div>
            ...
            <select id="allowedChildId" name="allowedChildId" className={inputClass}>
